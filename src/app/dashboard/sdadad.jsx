...
export default function FileViewer() {
  ...
  const userMobile = params.get("user"); // Get user mobile from URL
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="col-span-2 bg-white shadow rounded-lg p-6 relative">
              {activeSection === "referred-user" ? (
                <>
                  ...
                  <p className="text-red-600 absolute top-4 right-6 bg-red-200 px-3 py-1 rounded-lg">Inactive Account</p>
                  ...
                  <div className="bg-gray-300 h-10 rounded-lg mb-4"></div>
            ...
            <div className="col-span-2 bg-white shadow rounded-lg p-6 relative">
              {activeSection === "conversion-history" ? (
                    ...
                    <table className="w-full text-sm border border-gray-300">
                      ...
                      <tbody>
                        {[
                          ...
                          { id: "TXN0012348", date: "2025-02-16 06:00 AM", type: "Cash-In (Bank)", amount: "+₱2,000.00", points: "+100 Points", status: "Completed" },
                          { id: "TXN0012349", date: "2025-02-15 04:20 PM", type: "Conversion (500 Points)", amount: "+₱120.00", points: "-500 Points", status: "Completed" },
                        ].map((row, index) => (
                          <tr key={index} className="border-t border-gray-300">
                            <td className="p-2">{row.id}</td>
                            <td className="p-2">{row.date}</td>
                ...
                <h3 className="text-lg font-semibold">Other Section</h3>
              )}
            </div>
          </div>
        </div>
